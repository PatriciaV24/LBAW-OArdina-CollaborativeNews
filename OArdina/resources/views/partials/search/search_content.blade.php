<ul class="nav nav-pills mb-3  bg-light-dark" id="search-tab" role="tablist">
    <li class="nav-item " role="presentation">
        <button class="nav-link active text-white clickable" 
                id="search-news-tab" data-bs-toggle="pill" 
                data-bs-target="#search-news" 
                type="button" role="tab" 
                aria-controls="search-news" aria-selected="true">
                    Notícias
        </button>
    </li>
    @auth
...
<section class="tab-content"> 
    ...
    <div class="tab-pane fade show active" 
         id="search-news" 
         role="tabpanel" 
         aria-labelledby="search-news-tab">
            @if(count($news) === 0)
                <p class=" text-center h6 pt-4 pb-3">Resultados não encontrados</p>
            @else
